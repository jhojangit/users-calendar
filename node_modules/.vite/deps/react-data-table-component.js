...
var ge = function(e2) {
  ...
  for (; ye.has(ve); ) ve++;
  var t2 = ve++;
  if ((0 | t2) < 0 || t2 > 1073741824) throw he(16, "".concat(t2));
...
var Re = function() {
  ...
  return e2.registerId = function(e3) {
    ...
    if (ge(e3), this.names.has(e3)) this.names.get(e3).add(t2);
    else {
      var n = /* @__PURE__ */ new Set();
...
function at(t2) {
  for (var n = [], o2 = 1; o2 < arguments.length; o2++) n[o2 - 1] = arguments[o2];
  if (re(t2) || ce(t2)) return it(Ue(st(_, __spreadArray([t2], n, true))));
  var r3 = t2;
